<?php 
	...
	if(isset($_POST['answer']))
	{
		...
		if(strcasecmp($_POST['answer'],"god of small things") ==0 || strcasecmp($_POST['answer'],"the god of small things") == 0 )
		{
            $_SESSION['a']=false;
            $_SESSION['b']=false;            
...
<div class="container hints">
	<div class="row">
		<br/>
		<div class="col-md-offset-2 col-md-8">
			<div class="alert alert-success" role="alert">Casteist?</div>            
			<div class="alert alert-success" role="alert">"A Brief History of Seven Killings" is having something is common</div>
			<div class="alert alert-success" role="alert">First one in my Country to get this</div>
