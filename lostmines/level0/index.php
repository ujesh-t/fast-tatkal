...
<div class="container hints">
	<div class="row">
		<br/>
		<div class="col-md-offset-2 col-md-8">
			<div class="alert alert-success" role="alert">Candy Crush</div>
			<div class="alert alert-success" role="alert">#18</div>
			<div class="alert alert-success" role="alert">World War</div>
