<?php 
	...
	{
		if(strcasecmp($_POST['answer'],"god fatsher") == 0 || strcasecmp($_POST['answer'],"the god fatsher") == 0)
		{
			$a=true;
			$_SESSION['a']=true;
		}	

		if(strcasecmp($_POST['answer'],"quizup") ==0 || strcasecmp($_POST['answer'],"quiz up") == 0 )
		{
            $_SESSION['a']=false;
            $_SESSION['b']=false;            
	...
	$hint = array('1'=>'No More Hints','2'=>'No More Hints');
	...
	<div class="question row text-center">
		<div class="col-md-offset-2 col-md-8">
			<div style="margin-top:100px" class="col-md-12">
				<h2>Level 7 (Decode)</h2>
				<img class="img-responsive" src="images/xx.png"/>
			</div>
		</div>
	</div>
</div>
...
<div class="container hints">
	<div class="row">
		<br/>
		<div class="col-md-offset-2 col-md-8">
			<div class="alert alert-success" role="alert">Putin and Schwarzenegger, Their names says it all</div>            
			<div class="alert alert-success" role="alert">Schrödinger's ?</div>
			<div class="alert alert-success" role="alert">100 is less than 300, This will guide you when u counting</div>
			<div class="alert alert-<?php echo($a)?"success":"danger" ?>" role="alert"><?php echo($a)? $hint['1'] : "No More Hints"; ?></div>
