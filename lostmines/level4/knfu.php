<?php 
	...
	if(isset($_POST['answer']))
	{
		...
		if(strcasecmp($_POST['answer'],"angelina") ==0 || strcasecmp($_POST['answer'],"angelina jolie") == 0 )
		{
            $_SESSION['a']=false;
            $_SESSION['b']=false;            
			header("location:../level5/mpup.php");
		}
	}
	...
	$hint = array('1'=>'What is common between Hackers and this movie?','2'=>'No More Hints');
...
<div class="container hints">
	<div class="row">
		<br/>
		<div class="col-md-offset-2 col-md-8">
			<div class="alert alert-success" role="alert">Family separated miles apart... He lives in china while his brother in the arctic</div>            
			<div class="alert alert-success" role="alert">Get something from image and hint</div>
			<div class="alert alert-success" role="alert">Still nothing?? Remember Mantis??</div>
