<?php 
	...
	if(isset($_POST['answer']))
	{
		...
		if(strcasecmp($_POST['answer'],"god father") ==0 || strcasecmp($_POST['answer'],"the god father") == 0 )
		{
            $_SESSION['a']=false;
            $_SESSION['b']=false;            
			header("location:../level6/mkg.php");
		}
	}
...
<div class="container hints">
	<div class="row">
		<br/>
		<div class="col-md-offset-2 col-md-8">
			<div class="alert alert-success" role="alert">Me and My Puppet</div>            
			<div class="alert alert-success" role="alert">K K K <span class="text-danger">K</span></div>
			<div class="alert alert-success" role="alert">I Wrote, Answer is a Book with the Puppet</div>
