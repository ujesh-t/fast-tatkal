<?php 
	...
	{
		if(strcasecmp($_POST['answer'],"novel") == 0 || strcasecmp($_POST['answer'],"lily") == 0)
		{
			$a=true;
			$_SESSION['a']=true;
		}	
		if(strcasecmp($_POST['answer'],"potter")==0)
		{
			$b=true;
			$_SESSION['b']=true;
		}
	...
	$hint = array('1'=>'Lily and James, bond together','2'=>'The Boy who Lived');
...
<div class="container hints">
	<div class="row">
		<br/>
		<div class="col-md-offset-2 col-md-8">
			<div class="alert alert-success" role="alert">Add those two and u shall find</div>
			<div class="alert alert-success" role="alert">Very famous</div>
			<div class="alert alert-success" role="alert">Belongs to a Cult</div>
