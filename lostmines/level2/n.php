<?php 
	...
	{
		if(strcasecmp($_POST['answer'],"da vinci") == 0 || strcasecmp($_POST['answer'],"phi") == 0)
		{
			$a=true;
			$_SESSION['a']=true;
		}	
		if(strcasecmp($_POST['answer'],"golden ratio")==0)
		{
			$b=true;
			$_SESSION['b']=true;
		}
	...
	$hint = array('1'=>'--123--...','2'=>'The numbers associated with a ratio');
...
<div class="container hints">
	<div class="row">
		<br/>
		<div class="col-md-offset-2 col-md-8">
			<div class="alert alert-success" role="alert">The book has to do something with it</div>            
			<div class="alert alert-success" role="alert">Magnetic Flex <=> Electric Flex</div>
			<div class="alert alert-success" role="alert">MIT Card Counting Movie has a reference, Wait! Even this movie belongs</div>
			<div class="alert alert-<?php echo($a)?"success":"warning" ?>" role="alert"><?php echo($a)? $hint['1'] : "Need to Unlock"; ?></div>
			<div class="alert alert-<?php echo($b)?"success":"warning" ?>" role="alert"><?php echo($b)? $hint['2'] : "Need to Unlock"; ?></div>
		</div>
	</div>
</div>
